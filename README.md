...
```bash
curl -X POST "[http://127.0.0.1:8000/translate/text/hi](http://127.0.0.1:8000/translate/text/hi)" -H "Content-Type: application/json" -d '{"text": "Hello, world!", "include_audio": true}'
```
